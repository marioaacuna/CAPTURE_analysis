...
% Export folder
export_folder = fullfile(GC.temp_root, 'fig_zvals');
...
for exp_idx = 1:length(experiments)
    ...
    % Plot analysis for this experiment
    plot_experiment_analysis(exp_data, experiment, color_map, exp_export_folder, visualize, do_export);
