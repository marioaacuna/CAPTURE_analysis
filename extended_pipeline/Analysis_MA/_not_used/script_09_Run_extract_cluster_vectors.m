...
save_folder = "H:\Mario\Results_Capture\clusters";
...
% set variables:
% Given frame rate
ori_frame_rate = 120; % fps ; % This in the furture should be rad from general configuration file (general_config.mat || general_config.yaml)
...
% overlap between animals_of_interest and animal_list
animal_list = intersect(animal_list, animal_of_interest); % this will effectively leave some zeros in the conds_inds
