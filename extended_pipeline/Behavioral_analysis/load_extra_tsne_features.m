...
num_feat = [10,6,10,15,15, 5, 5, 5, 5, 5]; %names : 'ja_dyadic_spectrograms','appearance_features_agg_score_whitened','pose_score','spectrogram_pcs_wl_head_angle','spectrogram_pcs_wl_trunk_angle',...'ja_eig_spectrogrampcs', ... 'ja_eig_wlpcs',...,'ja_velocityhead_angle_difforder_100','ja_velocityhead_angle_difforder_300', 'ja_velocitytrunk_angle_difforder_100', ... 'ja_velocitytrunk_angle_difforder_300
