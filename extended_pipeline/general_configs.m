...
function GC = general_configs()
    ...
    GC.upsampling_to        = 300; % Used to upsampling for wavelet transformation, default: 300 - test 100
    GC.repfactor            = GC.upsampling_to / GC.frame_rate; % Repetition factor for the video; round(300/init_frame_rate)
